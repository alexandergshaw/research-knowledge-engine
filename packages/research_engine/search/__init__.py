"""Full-text search interface for the research engine.

Phase 1 implementation (FTS5 over SQLite) lives directly in this module.

TODO:
- Add search.semantic for embedding-based search (Phase 3+)
- Add search.hybrid for combined FTS + semantic ranking
"""
